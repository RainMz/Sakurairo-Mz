...
#video-add{
    background-image: url(<?=iro_opt('vision_resource_basepath', 'https://s3.rains.life/sakurairo-vision/')?>basic/add.svg);
}
@media (max-width:860px) {
  .headertop.filter-dot::before {
    background-image: url(<?=iro_opt('vision_resource_basepath', 'https://s3.rains.life/sakurairo-vision/')?>basic/grid.png);
  }
}
...
.headertop.filter-dot::before {
  background-image: url(<?=iro_opt('vision_resource_basepath', 'https://s3.rains.life/sakurairo-vision/')?>basic/dot.gif);
}
.loadvideo,.video-play {
  background-image: url(<?=iro_opt('vision_resource_basepath', 'https://s3.rains.life/sakurairo-vision/')?>basic/play.svg);
}

.video-pause {
  background-image: url(<?=iro_opt('vision_resource_basepath', 'https://s3.rains.life/sakurairo-vision/')?>basic/pause.svg);
}
#loading-comments {
background-image: url(<?=iro_opt('vision_resource_basepath', 'https://s3.rains.life/sakurairo-vision/')?>load_svg/ball.svg);
}

<?php if (iro_opt('wave_effects', 'true')): ?>
#banner_wave_1 {
    background: url(<?=iro_opt('vision_resource_basepath', 'https://s3.rains.life/sakurairo-vision/')?>basic/wave1.png) repeat-x;
}
#banner_wave_2 {
    background: url(<?=iro_opt('vision_resource_basepath', 'https://s3.rains.life/sakurairo-vision/')?>basic/wave2.png) repeat-x;
}
.headertop{
    border-radius:0 !important;
}
