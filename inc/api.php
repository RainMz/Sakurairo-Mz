...
function upload_image(WP_REST_Request $request)
{
    ...
    if (!check_ajax_referer('wp_rest', '_wpnonce', false)) {
        $output = array(
            ...
            'link' => "https://s3.rains.life/sakurairo-vision/basic/step04.md.png",
            'proxy' => iro_opt('comment_image_proxy') . "https://s3.rains.life/sakurairo-vision/basic/step04.md.png",
        );
